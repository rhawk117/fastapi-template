...
class PageParamsMixin(CustomBaseModel):
    """
...
class TimeStampParamsMixin(CustomBaseModel):
...
class SortParamsMixin(CustomBaseModel):
    order: Annotated[
        Literal['asc', 'desc'],
        Field(
            default='asc',
...
class PageMixin(CustomBaseModel, Generic[S]):
    """
